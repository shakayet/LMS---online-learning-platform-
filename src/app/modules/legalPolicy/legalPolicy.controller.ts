...
const getAllPolicies = catchAsync(async (req: Request, res: Response) => {
  const result = await LegalPolicyService.getAllPolicies(req.query);
...
const getActivePolicyByType = catchAsync(
  async (req: Request, res: Response) => {
    const { type } = req.params;
    const result = await LegalPolicyService.getActivePolicyByType(
      type as POLICY_TYPE,
    );
...
const upsertPolicy = catchAsync(async (req: Request, res: Response) => {
  ...
  const result = await LegalPolicyService.upsertPolicy(
    type as POLICY_TYPE,
    req.body,
    userId,
  );
...
const updatePolicy = catchAsync(async (req: Request, res: Response) => {
  const { type } = req.params;
  const userId = req.user?.userId;
  const result = await LegalPolicyService.updatePolicy(
    type as POLICY_TYPE,
    req.body,
    userId,
  );
...
const getAllActivePolicies = catchAsync(async (req: Request, res: Response) => {
  const result = await LegalPolicyService.getAllActivePolicies(req.query);
...
const initializeDefaultPolicies = catchAsync(
