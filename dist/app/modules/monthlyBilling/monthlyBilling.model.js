...
const monthlyBillingSchema = new mongoose_1.Schema({
    studentId: {
        type: mongoose_1.Schema.Types.ObjectId,
        ref: 'User',
    ...
    status: {
        type: String,
        enum: Object.values(monthlyBilling_interface_1.BILLING_STATUS),
        default: monthlyBilling_interface_1.BILLING_STATUS.PENDING,
    },
    stripeInvoiceId: {
        type: String,
    },
...
exports.MonthlyBilling = (0, mongoose_1.model)('MonthlyBilling', monthlyBillingSchema);
