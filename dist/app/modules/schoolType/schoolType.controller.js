...
const schoolType_service_1 = require("./schoolType.service");
const createSchoolType = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield schoolType_service_1.SchoolTypeService.createSchoolType(req.body);
