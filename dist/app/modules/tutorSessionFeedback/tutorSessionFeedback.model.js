...
exports.TutorSessionFeedback = void 0;
const mongoose_1 = require("mongoose");
const tutorSessionFeedback_interface_1 = require("./tutorSessionFeedback.interface");
const tutorSessionFeedbackSchema = new mongoose_1.Schema({
    sessionId: {
    ...
    feedbackType: {
        type: String,
        enum: Object.values(tutorSessionFeedback_interface_1.FEEDBACK_TYPE),
...
tutorSessionFeedbackSchema.pre('save', function (next) {
    ...
    else if (this.feedbackType === tutorSessionFeedback_interface_1.FEEDBACK_TYPE.AUDIO && !this.feedbackAudioUrl) {
...
exports.TutorSessionFeedback = (0, mongoose_1.model)('TutorSessionFeedback', tutorSessionFeedbackSchema);
